...
@Component({
  ...
  templateUrl: './othertransactionstats.component.html',
  styleUrls: ['./othertransactionstats.component.css']
})
export class OthertransactionstatsComponent implements OnInit {
